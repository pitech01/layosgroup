...
import { ChevronRight, Users, BookOpen, ArrowLeft, Layers, Loader2, Sparkles, LayoutGrid } from 'lucide-react';
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    {cohorts.length > 0 ? (
                        cohorts.map(cohort => (
                            <div 
                                key={cohort.id} 
                                className="bg-white dark:bg-brand-charcoal p-8 rounded-[40px] border border-brand-border flex flex-col h-full cursor-pointer group hover:shadow-2xl hover:shadow-brand-emerald/10 hover:-translate-y-2 transition-all duration-300 relative overflow-hidden"
                        ...
                        <div className="col-span-full py-24 text-center bg-white dark:bg-brand-charcoal border border-brand-border rounded-[40px] shadow-sm">
