        ...
        <div className="space-y-10 pb-12">
            <header className="animate-fade-in-up">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start gap-10">
                    ...
                    <div className="w-full lg:w-72 bg-white dark:bg-brand-charcoal p-6 rounded-[32px] border border-brand-border shadow-sm space-y-4">
                        <div className="flex justify-between items-center text-xs font-black uppercase tracking-widest text-brand-muted">
                            <span>Progress</span>
                            <span className="text-brand-emerald">{course.progress}%</span>
                        </div>
                        <div className="h-3 bg-brand-beige dark:bg-white/5 rounded-full overflow-hidden p-0.5 border border-brand-border">
                            <div 
