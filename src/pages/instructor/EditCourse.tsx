            ...
            <div className="sticky-actions-bar">
                ...
                <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center' }}>
                    <button
                        ...
                        disabled={loading}
                        style={{ background: '#f8fafc', border: '1.5px solid #e2e8f0', color: '#64748b', fontWeight: 800, padding: '0 1.5rem' }}
                    >
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="btn-standard"
                        style={{ background: '#1a4d3e', padding: '0 2.5rem', fontWeight: 900, boxShadow: '0 10px 20px -5px rgba(26, 77, 62, 0.2)' }}
                    >
                        {step === 4 ? 'Update Blueprint' : 'Proceed'}
                        ...
                        >
                            ...
                            <div style={{ padding: '4rem', textAlign: 'center' }}>
                                {viewingLesson.type === 'video' && (
                                    <div style={{ width: '100%', aspectRatio: '16/9', background: '#0f172a', borderRadius: '24px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', flexDirection: 'column', overflow: 'hidden', marginBottom: '2rem' }}>
                                ...
                                {viewingLesson.type === 'material' && (
                                    <div style={{ width: '100%', aspectRatio: '16/9', background: '#eff6ff', borderRadius: '24px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#2563eb', flexDirection: 'column', overflow: 'hidden', marginBottom: '2rem' }}>
