...
export default function InstructorAssignments() {
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-12 pb-32 px-6 md:px-0">
            ...
            <div className="flex items-center justify-center gap-6 p-10 bg-brand-beige/10 dark:bg-white/5 rounded-[40px] border border-brand-border border-dashed text-brand-muted text-[10px] font-black uppercase tracking-[0.2em] animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
