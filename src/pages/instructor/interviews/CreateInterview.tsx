    ...
    return (
        <div className="create-interview-container">
            <style>{`
                ...
                .icon-box { background: #f1f5f9; padding: 12px; border-radius: 12px; color: #1a4d3e; }
                .form-group { display: flex; flex-direction: column; gap: 10px; margin-bottom: 2rem; }
            ...
            <div className="form-card">
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', background: '#f8fafc', padding: '1rem', borderRadius: '12px', marginBottom: '2rem', border: '1px solid #e2e8f0' }}>
                        ...
                        <span style={{ fontSize: '0.8rem', color: '#64748b', fontWeight: 600 }}>Files will be securely stored on S3. Max limits: 50MB for docs, 500MB for videos.</span>
                    </div>

                    <button className="btn-submit" disabled={isSubmitting}>
                        {isSubmitting ? (
                            <><Loader2 className="animate-spin" size={20} /> Uploading to S3...</>
                        ) : (
